...
def get_service_details():
    ...
    return 'Service details retrieved successfully'
...
def get_operation_status():
    ...
    return 'Operation status retrieved successfully'
...
def get_operation_logs():
    ...
    return 'Operation logs retrieved successfully'
